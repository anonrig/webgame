...
function Routes() {
    ...
    self.init = function (app) {
        ...
        app.get('/', home.viewIndex);
				app.get('/faq', home.viewFaq);
				app.get('/contactus', home.viewContactUs);
				app.get('/version', home.viewVersion);
				app.get('/theteam', home.viewTheTeam);
        //endregion
        ...
        app.get('/leaderboard', auth.ensureAuthenticated, games.viewLeaderboard);
